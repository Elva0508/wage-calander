...
- 工作詳細頁未來擴充:自訂獎金、完整薪資明細(請假/扣薪/加班費/津貼/勞健保扣除等)——使用者已列為待辦,尚未定案要怎麼做。討論具體規格時要一併決定架構界線問題:獎金/扣款這類「跟時間無法自然對應」的一次性金額,要不要同步顯示進工時統計的薪水總和(工時統計目前只反映可以按天攤算的東西:時薪/日薪逐班金額 + 月薪攤算)——目前傾向的方向是獎金/扣款只在發薪日曆顯示、不強求兩邊金額一致(跟月薪攤算是連續性金額不同,獎金通常是一次性,攤算沒有意義),但使用者想先看過獎金功能的具體規格再拍板
